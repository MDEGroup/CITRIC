...
public class ReferenceMutation extends KM3BasicMutator{
	...
	public static String basicInstance() {
		...
		// create the content of the model via this programREFERENCE_PATH
		...
		String outputPath = REFERENCE_PATH + "KM3_Reference_BASE.xmi";
	...
	public static String setOpposite() {
		...
		String outputPath = REFERENCE_PATH + "KM3_opposite_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String unsetOpposite() {
		...
		String outputPath = REFERENCE_PATH + "KM3_opposite_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String setIsContainer() {
		...
		String outputPath = REFERENCE_PATH + "KM3_reference_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String unsetIsContainer() {
		...
		String outputPath = REFERENCE_PATH + "KM3_reference_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String setOwner() {
		...
		String outputPath = REFERENCE_PATH + "KM3_owner_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String unsetOwner() {
		...
		String outputPath = REFERENCE_PATH + "KM3_owner_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String setType() {
		...
		String outputPath = REFERENCE_PATH + "KM3_type_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String unsetType() {
		...
		String outputPath = REFERENCE_PATH + "KM3_type_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String setIsOrdered() {
		...
		String outputPath = REFERENCE_PATH + "KM3_isOrdered_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String unsetIsOrdered() {
		...
		String outputPath = REFERENCE_PATH + "KM3_isOrdered_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String setIsUnique() {
		...
		String outputPath = REFERENCE_PATH + "KM3_isUnique_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String unsetIsUnique() {
		...
		String outputPath = REFERENCE_PATH + "KM3_isUnique_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String setUpper() {
		...
		String outputPath = REFERENCE_PATH + "KM3_upper_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	public static String unsetUpper() {
		...
		String outputPath = REFERENCE_PATH + "KM3_upper_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String setLower() {
		...
		String outputPath = REFERENCE_PATH + "KM3_lower_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String unsetLower() {
		...
		String outputPath = REFERENCE_PATH + "KM3_lower_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String setName() {
		...
		String outputPath = REFERENCE_PATH + "KM3_name_set.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
	...
	public static String unsetName() {
		...
		String outputPath = REFERENCE_PATH + "KM3_name_unset.xmi";
		ModelManager.serializeModelInstance(km3Metamodel, outputPath);
		return outputPath;
	}
