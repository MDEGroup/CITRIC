...
The Table2SVGPieChart project is used to extract a SVG file containing pie
...
Contents:
  --> "Table2SVGPieChart": The ATL project folder.
    |--> "conf": The folder which contains configuration files.
      \--> "Table2SVGPieChart build.xml.launch": The configuration file of the
ANT script "build.xml".
 ...
 Ecore format.
    ...
    |--> "models": The folder which contains input and output models.
      ...
      \--> "example-SVGPieChart.svg": The file generated for the example.
